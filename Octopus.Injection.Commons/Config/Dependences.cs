...
{
    [ConfigurationCollection(typeof(DependenceConf), AddItemName = "dependence", CollectionType = ConfigurationElementCollectionType.BasicMap)]
    public class Dependences : ConfigurationElementCollection
    {
